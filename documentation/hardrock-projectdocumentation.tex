...
\chapter{Auswertung}
	...
	\section{Bewertung der Resultate}
		Das Optimum mit 14 Köchen scheint auf den ersten Blick relativ gross zu sein. Die Konsultation eines Experten hat ergeben, dass der Zeitaufwand für die Zubereitung und die Möglichkeit zur Parallelität stark von der Speisekarte, den Gegebenheiten des Betriebs und der Erfahrungen des Personals abhängt. Hinzu kommen die saisonalen Schwankungen, welche schwierig ab zu schätzen sind. Das in der Simulation gefundene Optimum müsste empirisch Bestätigt werden. 

		Es wäre durchaus denkbar, dass zu Stosszeiten mehr Personal in der Küche zum Einsatz kommt und man hier mit Arbeitsschichten optimieren kann. Der in der Simulation gefundene Wert variiert aber nicht, sondern ist fix über die Simulationsdauer festgelegt. Die Simulation könnte in Folgeprojekten auf Schichtenplanungen ausgebaut werden. 
...
\chapter{Arena Report}
	...
	\end{center}
	\begin{center}
		\includegraphics[page=2, trim=0cm 0cm 0cm 0cm, clip=true, width=\textwidth]{../Auswertung/Raport 14-3-9/category overview.pdf}
	\end{center}
	\begin{center}
