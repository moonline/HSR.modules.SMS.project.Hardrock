...
\begin{center}
	\includegraphics[page=1,angle=180, scale=0.67]{media/Abschlusspraesentation-Hardrock-slides.pdf}
\end{center}
\begin{center}
	\includegraphics[page=2,angle=180, scale=0.8]{media/Abschlusspraesentation-Hardrock-slides.pdf}
\end{center}
\begin{center}
	\includegraphics[page=3,angle=180, scale=0.8]{media/Abschlusspraesentation-Hardrock-slides.pdf}
\end{center}
\begin{center}
	\includegraphics[page=4,angle=180, scale=0.8]{media/Abschlusspraesentation-Hardrock-slides.pdf}
\end{center}
\begin{center}
	\includegraphics[page=5,angle=180, scale=0.8]{media/Abschlusspraesentation-Hardrock-slides.pdf}
\end{center}
