...
\section{Objectives}
	...
	\subsection{Grösse der Bar}
		Die Bar funktioniert als Puffer für wartende Gäste. So kann das Restaurant auf einen Tisch wartende Gäste trotzdem aufnehmen und erzeugt in der Realität auch Umsatz damit. Wir lassen diesen Aspekt unberücksichtigt. Eine mögliche Fragestellung ist, ob die bei 40 Plätzen angesetzte Grösse der Bar optimal ist.
...
\chapter{Auswertung}
		...
		\subsection{Kriterium Bargrösse}	
			Die Frage, ob eine Bargrösse von 40 Personen ausreichend ist, lässt sich mit allen Simulationsläufen bejahen. Da die Bar jedoch als unabhängiges Teilsystem funktioniert und deren Umsatz nicht in die Gewinnberechnung miteinbezogen wird, ist diese Frage ausgelagert. Die Auslastung der Bar wurde in der Simulation erhoben und liegt bei einem geringen Wert. Voll besetzt ist sie nur am Abend. Es ist zu überprüfen, ob eine Verkleinerung angebracht wäre. Dies könnte in einem Folgeprojekt überprüft werden. 
