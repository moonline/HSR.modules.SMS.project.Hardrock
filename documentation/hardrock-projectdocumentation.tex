...
Das Servierpersonal an der Bar soll in unserer Simulation nicht berücksichtigt werden. Grund dafür ist die Unabhängigkeit des Barpersonals vom Rest des Lokals. Das Barersonal verlässt nicht kurzzeitig die Bar und bedient noch Tische, sondern bedient nur die Gäste an der Bar.
...
In der realen Welt bestehen die Tische aus Vierertischen. Ankommenden Gruppen müssen aufgeteilt werden. Oder Tische zusammengeschoben werden. Bei weniger als 4 Personen kann es zu leeren Plätzen kommen. Um die Simulation nicht unnötig aufzublähen, soll dies nicht berücksichtigt werden in der Simulation.
...
\subsection{Küche}
	In der Küche werden die verschiedenen Mahlzeiten gekocht und angerihtet. Die Köche arbeiten gleichzeitig an mehreren Menüs und versuchen, zusammengehörende Menüs möglichst gleichzeitig fertigzustellen.
...
\chapter{Simulation mit Arena}
	...
	\section{Blausibilitätscheck}
	Zur Überprüfung der Plausibilität des aufgebauten Arena Modells variierten wir verschiedene Parameter. Dabei sind einige Dinge aufgefallen:
	\begin{itemize}
		...
		\item Fünf Serviceangestellte und drei Tellerbringer sind trotz 250 Gästen zu wenig ausgelastet.\\
		$\rightarrow$ Hier müssen wir die Zeiten für das Servicepersonal und die Tellerbringer noch noch oben korrigieren.
		\item Die Köche stellen den Flaschenhals dar. Daraus ergibt sich eine tiefe Utilization des Servicepersonals. Um dieses Problem zu beheben, sollte die Anzahl der Köche im Verhältnis zur Anzahl Servicepersonal erhöht werden.
...
\begin{center}
	\includegraphics[page=1,angle=180, scale=0.7]{media/presentation-hardrock-slides.pdf}
\end{center}
\begin{center}
